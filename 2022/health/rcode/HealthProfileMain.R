...
CSVForHTML <- EDWGUIDAC%>%select(ED,GUID,AC,EDLC,ACLC)
...
# link to map for ED
EDMapLink <- paste0(InputFilesLoc,"/exportededmaps/",EDGUID,".jpg")
...
EDLinkPDF<- paste0("<font size=\"5\"><a href=\".\\profiles\\pdf\\",i,"-csohealthprofile--edname--",EDLC,"--acname--",ACLC,"--edguid--",EDGUIDLC,".pdf\""," style=\"text-decoration: none\">A more detailed and print friendly pdf profile - with accompanying tables - is available here.</a></font>")
